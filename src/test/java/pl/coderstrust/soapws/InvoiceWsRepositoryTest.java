...
/**
 * InvoiceWsRepositoryTest
 */
public class InvoiceWsRepositoryTest {
  ...
  public void shouldReturnInvoiceRepository() {
    ...
    //when
    InvoiceWsRepository invoiceWsRepository = new InvoiceWsRepository(invoiceBook);
    //then
    assertThat(invoiceWsRepository).isNotNull();
  ...
  public void shouldFindInvoice() throws Exception {
    ...
    //when
    InvoiceWS invoiceWSActual = invoiceWsRepository.findInvoice(id);
    //then
  ...
  public void shouldFindInvoices() throws Exception {
    ...
    //when
    List<InvoiceWS> actualList = invoiceWsRepository.findInvoices();
    //then
  ...
  public void shouldFindInvoicesByYearAndMonth() throws Exception {
    ...
    //when
    List<InvoiceWS> actualList = invoiceWsRepository
  ...
  public void shouldFindInvoicesFromDateToDate() throws Exception {
    ...
    when(invoiceBook.getInvoices(LocalDate
        ...
        .thenReturn(invoices);
    //when
    List<InvoiceWS> actualList = invoiceWsRepository.findInvoicesFromDateToDate(LocalDate
        .of(2017, 6, 1), LocalDate.of(2017, 8, 1));
    //then
    assertEquals(expectedList.get(0).getId(), actualList.get(0).getId());
    assertEquals(expectedList.get(0).getDate(), actualList.get(0).getDate());
  ...
  public void shouldSaveInvoice() throws Exception {
    ...
    when(invoiceBook.createInvoice(any(InvoiceBody.class))).thenReturn(invoice);
    //when
    invoiceWsRepository.saveInvoice(invoiceBodyWS);
  ...
  public void shouldUpdateInvoice() throws Exception {
    ...
    //when
    int actualId = invoiceWsRepository.updateInvoice(expectedId, invoiceBodyWS);
    //then
  ...
  public void shouldRemoveInvoice() throws Exception {
    ...
    //when
    Integer actualId = invoiceWsRepository.removeInvoice(expectedId);
